...
|--------|--------|----------|-------|
| OpenAPI YAML | tested | `tests/data/openapi/**/*.yaml` (41 fixtures) | Primary fixture format exercised under `tests/data/openapi/**/*.yaml`. |
...
| Coverage fixtures | 16 | `callbacks.yaml`, `callbacks_with_operation_id.yaml`, `faux_immutability.yaml` | Focused fixtures for callbacks, non-200 responses, and other regression edges. |
